...
// Èíèöèàëèçàöèÿ ñòàòè÷åñêèõ ÷ëåíîâ
template<typename T>
...
public:
    ...
    // Äîáàâëÿåì ìåòîäû getAttack() è getDefense()
...
void Monster::attackPlayer(Character& player) {
    int damage = attack - player.getDefense(); // Èñïîëüçóåì getDefense()
    if (damage > 0) {
